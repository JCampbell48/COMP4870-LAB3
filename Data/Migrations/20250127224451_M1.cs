    ...
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProvinceCode = table.Column<string>(type: "TEXT", maxLength: 5, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 675000, "BC" },
                    { 2, "Surrey", 517000, "BC" },
                    { 3, "Burnaby", 249000, "BC" },
                    { 4, "Toronto", 2730000, "ON" },
                    { 5, "Ottawa", 934000, "ON" },
                    { 6, "Mississauga", 721000, "ON" },
                    { 7, "Montreal", 1705000, "QC" },
                    { 8, "Quebec City", 542000, "QC" },
                    { 9, "Laval", 438000, "QC" }
                });
